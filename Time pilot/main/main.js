...
function preload(){
  ...
  keys = [[loadImage('images/U0.png'), loadImage('images/U1.png')],
          [loadImage('images/R0.png'), loadImage('images/R1.png')],
          [loadImage('images/D0.png'), loadImage('images/D1.png')],
          [loadImage('images/L0.png'), loadImage('images/L1.png')]
        ]
...
function keyPressed(){
   if(keyCode === UP_ARROW){
     ...
     if(!game.is_tutorial && !game.is_game_over){
     ...
     if(game.is_game_over){
        ...
        game.restart();
     }else if(game.is_tutorial){
       game.is_tutorial = false;
     }
   }
}
